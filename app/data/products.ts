export const PRODUCTS = [
...

  {
    ...
    what:
      "GHK-Cu es un péptido unido al cobre, asociado con procesos de reparación, colágeno y salud de la piel.",
    use:
...

{
...

  {
    ...
    pageTitle: "NAD+",
    shortDescription:
      "Compuesto clave en energía celular, envejecimiento saludable y rendimiento metabólico.",
    what:
      "NAD+ es una coenzima esencial involucrada en la producción de energía celular y procesos de reparación.",
    use:
      "Se utiliza en protocolos de energía, bienestar celular, longevidad, enfoque mental y anti-aging.",
    benefits:
...

  {
    ...
    pageTitle: "NR-500",
    shortDescription:
      "Precursor de NAD+ utilizado en protocolos de energía, longevidad y metabolismo celular.",
    what:
      "NR, o nicotinamida ribósido, es un precursor de NAD+, molécula importante para energía celular.",
    use:
      "Se utiliza en protocolos de apoyo energético, salud celular, envejecimiento saludable y rendimiento.",
    benefits:
      "Puede favorecer energía, enfoque, función celular y bienestar metabólico.",
  },
