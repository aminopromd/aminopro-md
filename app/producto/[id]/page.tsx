...
> = {
  ...
  "mt2-10": {
    ...
    benefits: (
      <ul>
        ...
        <li>
          Puede reducir el tiempo de exposición al sol necesario para broncearse.
        </li>
        <li>
          Utilizado en protocolos de ANTI-AGING y estética bajo supervisión
          profesional.
        </li>
      </ul>
    ),
  ...
  "reta-5": {
    ...
    benefits: (
      <ul>
        ...
        <li>
          Aumenta el metabolismo lo que lleva a una quema de calorías mas alta.
        </li>
  ...
  glow: {
    ...
    what:
      "Es una perfecta combinación de péptidos diseñada para una mejor regeneración, reparación de la piel y otros tejidos, a nivel celular.",
    use:
      "Se utiliza en protocolos enfocados en ANTI-AGING, rejuvenecimiento, reducción de inflamación, para obtener un pelo, piel y uñas firmes, brillosos y saludables.",
    benefits: (
      <ul>
  ...
  "dsip-5": {
    ...
    what:
      "DSIP(Delta Sleep Inducing Peptide) es un péptido natural asociado con la regulación del sueño, especialmente el sueño profundo (fase delta), la cual es clave para la recuperación física y mental.",
    use:
      "Se utiliza en protocolos enfocados en mejorar la calidad del sueño, maximizar la recuperación durante el sueño, reducir estrés y fatiga mental.",
    benefits: (
      <ul>
  ...
  "motsc-10": {
    ...
    what:
      "MOTS-C es un péptido derivado de las mitocondrias (la “central de energía” de la célula) que participa en la regulación del metabolismo energético y la utilización de nutrientes.",
    use:
      "Se utiliza en protocolos enfocados en maximizar el uso de grasas (Lipotrópico), aumentar la producción de energia, mejorar el rendimiento físico durante entrenos, altamente ANTI-AGING.",
    benefits: (
      <ul>
        <li>Altamente ANTI-AGING.</li>
  ...
  "lipoc-10": {
    ...
    what:
      "Es una perfecta combinación LIPOTRÓPICA diseñada para maximizar el metabolismo de las grasas y aumentar los niveles de energía corporal.",
    use:
      "Se utiliza en protocolos enfocados en aumentar y maximizar la perdida de grasa corporal, aumentar los niveles de energía, como complemento de programas para pérdida de peso.",
    benefits: (
      <ul>
        ...
        <li>
          Tiene efecto DETOX ayudando a mantener una función hepática saludable.
        </li>
      </ul>
    ),
  },
  ...
  "bacwa-10": {
    ...
    what:
      "BAC WATER es agua estéril bacteriostática que contiene una pequeña cantidad de alcohol bencílico (0.9%), utilizado para ayudar a prevenir el crecimiento bacteriano despues de la reconstitución de un péptido.",
    use:
      "Ideal para la reconstitución de péptidos, para prevenir crecimiento bacteriano despues de reconstituir cualquier péptido liofilizado.",
    benefits: (
      <ul>
  ...
  "ghkcu-50": {
    ...
    what:
      "Conocido popularmente como LA FUENTE DE LA JUVENTUD, el GHK-Cu es un péptido natural formado por 3 aminoácidos unidos a cobre. Está relacionado con la regeneración de dejidos, producción de colágeno y reparación celular.",
    use:
      "Se usa en protocolos para reparación a nivel celular, procesos ANTI-AGING, estimulación de folículos de cabello para que crezca sano y brilloso, estimulación de producción de colágeno para una piel sana y con un GLOW saludable.",
    benefits: (
      <ul>
  ...
  "cjcipa-5": {
    ...
    use:
      "Esta combinación se usa en protocolos enfocados en aumento de masa muscular magra, una mejor recuperación corporal despues de entrenar, un mejor descanso muscular y como ANTI-AGNING.",
    benefits: (
  ...
  "bpc157-10": {
    ...
    what:
      "El BPC-157 es un péptido compuesto por 15 aminoácidos, derivado de proteínas presentes en el sistema gastrointestinal. Es conocido por su relación con procesos de reparación y regeneración de tejidos.",
    use:
      "Se usa en protocolos enfocados en recuperación muscular, lesiones de tendones y ligamentos, anti-inflamatorio, para una recuperación despues de entrenos.",
    benefits: (
      <ul>
        ...
        <li>
          Tiene propiedades que mantienen una buena salud gastrointestinal.
        </li>
      </ul>
    ),
  },
  ...
  "tb500-10": {
    ...
    what:
      "El TB-500 es un péptido derivado de la timosina beta-4, una proteína natural involucrada en procesos de reparación y regeneración celular.",
    use:
      "Se usa en protocolos enfocados en recuperación muscular, lesiones de tendones y ligamentos, anti-inflamatorio, para una recuperación despues de entrenos.",
    benefits: (
      <ul>
  ...
  "nad-1000": {
    ...
    what:
      "El NAD+ es una coenzima escencial presente en todas las células del cuerpo. Participa en procesos clave de producción de energía, procesos antioxidantes y metabolismo celular.",
    use:
      "Se utiliza en protocolos enfocados en ANTI-AGING, aumento de la energía celular, aumento de la claridad mental, apoyo en el metabolismo celular, ayuda a una recuperación celular mas sana.",
    benefits: (
      <ul>
        <li>ANTI-AGING</li>
  ...
  "nr-500": {
    ...
    what:
      "La Nicotinamida Ribosida o NR, es una forma de vitamina B3 que el cuerpo utiliza como precursor directo de NAD+ una molécula clave para la producción de energía celular.",
    use:
      "Se utiliza en protocolos enfocados en aumentar niveles de NAD+, ANTI-AGING, aumento de la claridad mental y conectración, aumento de la energía",
    benefits: (
      <ul>
        <li>ANTI-AGING</li>
  ...
  bolsa1: {
    ...
    what:
      "Una bolsa suave y resistente diseñada para durar y aguantar tu equipo, como guantes, toallas, pachones, tennis, etc. Facil de lavar y secar.",
    use:
      "Ideal para guardar tu equipo de workout cuando vas al gimnasio, mantiene fresco tu equipo y ventilado, suave y ligera de llevar.",
    benefits: (
      <ul>
...
export default function ProductPage() {
  ...
  const info = PRODUCT_INFO[product.id] || {
    ...
    use:
      ...
      "Uso dentro de un plan supervisado.",
    benefits:
...
Nota:`;
  ...
  return (
    <main className="min-h-screen bg-white text-black">
      ...
      <section className="w-full px-6 md:px-12 py-10">
        ...
        <div className="text-center mt-6">
          ...
          <p className="text-gray-600 mt-4 max-w-3xl mx-auto">
            ...
            de investigación y no se recomienda su uso en humanos. Consulta a
            tu médico.
          </p>
              ...
              <div className="mt-5 flex flex-col gap-3">
                ...
                {product.coas.map((coa) => (
                  <a
                    ...
                    className="w-full rounded-xl border-2 border-lime-400 bg-white px-4 py-3 text-center font-bold text-black transition hover:bg-lime-50 hover:border-lime-500"
                  >
                    {coa.label}
                  </a>
                ))}
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-4">
              ...
              <div className="border p-5 rounded-xl shadow-sm bg-white">
                ...
                <div className="text-sm mt-3 text-gray-600 text-left">
                  {info.benefits}
                </div>
      ...
      <section
        id="aviso-legal"
        className="w-full px-6 md:px-12 pb-12"
      >
